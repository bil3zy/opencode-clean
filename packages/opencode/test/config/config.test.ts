...
describe("resolvePluginSpec", () => {
  test("keeps package specs unchanged", async () => {
    ...
    expect(await Config.resolvePluginSpec("example-plugin@1.0.0", file)).toBe("example-plugin@1.0.0")
...
describe("deduplicatePluginOrigins", () => {
  ...
  test("keeps path plugins separate from package plugins", () => {
    const plugins = ["example-plugin@1.0.0", "file:///project/.opencode/plugin/example-plugin.js"]
