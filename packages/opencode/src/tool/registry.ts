...
import { SearXNGSearchTool } from "./searxng-search"
import { ResearchWebsearchTool } from "./research-websearch"
...
| Truncate.Service
  ...
  > = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const searxng = yield* SearXNGSearchTool
      const researchwebsearch = yield* ResearchWebsearchTool
      const bropsernavigate = yield* BrowserNavigateTool
      ...
      const state = yield* InstanceState.make<State>(
        Effect.fn("ToolRegistry.state")(function* (ctx) {
          ...
          const tool = yield* Effect.all({
            ...
            plan: Tool.init(plan),
            searxng: Tool.init(searxng),
            researchwebsearch: Tool.init(researchwebsearch),
            bropsernavigate: Tool.init(bropsernavigate),
  ...
  export const defaultLayer = Layer.suspend(() =>
    layer.pipe(
      ...
      Layer.provide(BrowserPool.defaultLayer),
    ),
  )
}
